...
/**
 * 	\defgroup	breadcrumb	breadcrumb module
 * 	\brief		breadcrumb module descriptor.
 * 	\file		core/modules/modbreadcrumb.class.php
 * 	\ingroup	breadcrumb
 * 	\brief		Description and activation file for module breadcrumb
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module breadcrumb
 */
class modBreadcrumb extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 104899; // 104000 to 104999 for ATM CONSULTING
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'breadcrumb';
        ...
        // Example: this->dirs = array("/breadcrumb/temp");
        $this->dirs = array();
        ...
        $this->langfiles = array("breadcrumb@breadcrumb"); // langfiles@breadcrumb
        // Constants
        ...
        $this->tabs = array(
            ...
            //	'objecttype:+tabname1:Title1:langfile@breadcrumb:$user->rights->breadcrumb->read:/breadcrumb/mynewtab1.php?id=__ID__',
            //	// To add another new tab identified by code tabname2
            //	'objecttype:+tabname2:Title2:langfile@breadcrumb:$user->rights->othermodule->read:/breadcrumb/mynewtab2.php?id=__ID__',
        ...
        // Dictionnaries
        if (! isset($conf->breadcrumb->enabled)) {
            $conf->breadcrumb=new stdClass();
            $conf->breadcrumb->enabled = 0;
        }
        $this->dictionnaries = array();
        /* Example:
          // This is to avoid warnings
          if (! isset($conf->breadcrumb->enabled)) $conf->breadcrumb->enabled=0;
          $this->dictionnaries=array(
          'langs'=>'breadcrumb@breadcrumb',
        ...
        $this->boxes[$r][1] = "breadcrumb_box@breadcrumb";
        $r ++;
        /*
        ...
        //	'type'=>'top',
        //	'titre'=>'breadcrumb top menu',
        //	'mainmenu'=>'breadcrumb',
        //	'leftmenu'=>'breadcrumb',
        //	'url'=>'/breadcrumb/pagetop.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
        //	// Define condition to show or hide menu entry.
        //	// Use '$conf->breadcrumb->enabled' if entry must be visible if module is enabled.
        //	'enabled'=>'$conf->breadcrumb->enabled',
        //	// Use 'perms'=>'$user->rights->breadcrumb->level1->level2'
        ...
        //	'type'=>'left',
        //	'titre'=>'breadcrumb left menu',
        //	'mainmenu'=>'breadcrumb',
        //	'leftmenu'=>'breadcrumb',
        //	'url'=>'/breadcrumb/pagelevel1.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
     ...
     * and create data commands must be stored in directory /breadcrumb/sql/
    ...
    {
        return $this->_load_tables('/breadcrumb/sql/');
    }
}
